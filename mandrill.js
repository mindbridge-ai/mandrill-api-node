...
(function() {
  var Exports, Inbound, Internal, Ips, Messages, Metadata, OPTS, Rejects, Senders, Subaccounts, Tags, Templates, Urls, Users, Webhooks, Whitelists, request;
  ...
  exports.Mandrill = class Mandrill {
    ...
    call(uri, params = {}, onresult, onerror) {
      ...
      if (this.debug) {
        console.log(`Mandrill: Opening request to ${OPTS.uri}`);
      }
